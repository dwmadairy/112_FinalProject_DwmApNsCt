...
In this plot we have a stacked plot that  shows the general reasons why expeditions fail overtime. In recent years there has been a general rise in weather related issues on the moutansin as well as increases in avalanches. We also see that fatalies remains relatively flat over time, but there is an increase in the number. 
