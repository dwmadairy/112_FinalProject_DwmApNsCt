...
climberpeakV2 %>%
  ...
  filter(PKNAME == "Everest"
         ...
         |PKNAME == "Manaslu") %>%
  filter(YEAR > 1975) %>%
  ggplot(aes(x = YEAR, y = expeditions, color = PKNAME)) + 
  geom_smooth(se = FALSE) +
  labs(x = "Year", y = "Expeditions", color = "Peak Name") + 
  ggtitle("Peak Popularity Over Time")
```

As shown in the Leaflet, some of the most popular peaks have low success rate, like Aannapurna I, where only 1/3 of climbers reach the summit. Why do these climbers fail?
>>>>>>> 9b24466a7967987f42cea043227600e5b0c32855
